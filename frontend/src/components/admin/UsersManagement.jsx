              ...
              <div className="form-grid">
                ...
                <div className="form-group checkbox-group full-width">
                  <label htmlFor="add-isAdmin" className="checkbox-label">
                    <input type="checkbox" id="add-isAdmin" name="isAdmin" checked={newUser.isAdmin} onChange={handleInputChange} />
              ...
              <div className="form-grid">
                ...
                <div className="form-group checkbox-group full-width">
                  <label htmlFor="edit-isAdmin" className="checkbox-label">
                    <input type="checkbox" id="edit-isAdmin" name="isAdmin" checked={editingUser.isAdmin} onChange={handleEditInputChange} />
                    <span>Grant Admin Privileges</span>
                  </label>
                </div>
